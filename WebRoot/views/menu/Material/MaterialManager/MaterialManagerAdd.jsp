...
<body>
	<table class="vtb">
		...
		<tr>
			...
			<td>
				<select id="type" name="type" onchange="chapterChange(this)">
		...
		$(function() {
			$("#btn_sub").click(
					function() {
						...
						if (name == '' || name == undefined) {alert("标题不能为空");return;}
						// 这里后续添加其他项的验证
						if (hasContents != true) {alert("内容不能为空");return;}
						$.ajax({
							type : "POST",
