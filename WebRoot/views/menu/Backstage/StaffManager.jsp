...
<body>
	...
	function getAllRole() {
		...
		function StaffManagerUpd() {
			updateobj(gb("StaffManagerUpd").name, gb("StaffManagerUpd").link, "", "");
		}
		function StaffManagerAdd() {
			addobj(gb("StaffManagerAdd").name, gb("StaffManagerAdd").link, "", "");
		}
		function StaffManagerDel() {
			delobj("/busi/StaffManagerDel.do");
		}
		function StaffManagerUpdPassword() {
			updateobj(gb("StaffManagerUpdPassword").name, gb("StaffManagerUpdPassword").link, "", "");
		}
		function StaffManagerUpdStatus() {
			if (selectonly() == true) {
				...
				updateo("/busi/StaffManagerUpdStatus.do", data);
			}
		}
	</script>
</body>
