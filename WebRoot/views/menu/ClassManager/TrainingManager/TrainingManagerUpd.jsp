...
<script type="text/javascript">
	$(function() {
		...
		valform("question", formdata[0].question, "textarea");
		valform("optiona", formdata[0].optiona, "");
		valform("optionb", formdata[0].optionb, "");
		valform("optionc", formdata[0].optionc, "");
		valform("optiond", formdata[0].optiond, "");
		valform("answer", formdata[0].answer, "");
		valform("explains", formdata[0].explains, "textarea");
		valform("type", formdata[0].type, "select");
		valform("degree", formdata[0].degree, "select");
	});
