...
<body>
	...
	<script type="text/javascript">
		...
		function QandaManagerAdd() {
			addobj(gb("QandaManagerAdd").name, gb("QandaManagerAdd").link, 1000, 600);
		}

		function QandaManagerUpd() {
			updateobj(gb("QandaManagerUpd").name, gb("QandaManagerUpd").link, 1000, 600);
		}
		function QandaManagerDel() {
			delobj("/busi/QandaManagerDel.do");
		}
		function QandaManagerSearch() {
			QandaManagerSearch
		}
	</script>
</body>
