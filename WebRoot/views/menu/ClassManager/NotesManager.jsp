...
<body>
	...
	<script type="text/javascript">
		...
		function NotesManagerAdd() {
			addobj(gb("NotesManagerAdd").name, gb("NotesManagerAdd").link, 1000, 600);
		}

		function NotesManagerUpd() {
			updateobj(gb("NotesManagerUpd").name, gb("NotesManagerUpd").link, 1000, 600);
		}
		function NotesManagerDel() {
			delobj("/busi/NotesManagerDel.do");
		}
		function NotesManagerSearch() {
			NotesManagerSearch
		}
	</script>
</body>
