...
<body>
	...
	<script type="text/javascript">
		...
		function VideoManagerAdd() {
			addobj(gb("VideoManagerAdd").name, gb("VideoManagerAdd").link, 700, 400);
		}

		function VideoManagerUpd() {
			updateobj(gb("VideoManagerUpd").name, gb("VideoManagerUpd").link, 700, 400);
		}
		function VideoManagerDel() {
			delobj("/busi/VideoManagerDel.do");
		}
		function VideoManagerSearch() {
			VideoManagerSearch
		}
	</script>
</body>
