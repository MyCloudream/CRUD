...
public class ChapterDaoImpl extends BaseDao<Chapter> implements ChapterDao{
	...
	@Override
	public Integer add(Chapter entity) {
		try {
	...
	@Override
	public boolean upd(Chapter entity) {
		try {
	...
	public boolean del(Integer id) {
		try {
			super.deleteEntity(new Chapter(id));
			return true;
		} catch (Exception e) {
	...
	public Chapter findById(Integer id) {
		try {
			return super.get(Chapter.class, id);
		} catch (Exception e) {
			logger.error("dao≤È’“¥ÌŒÛ", e);
			return null;
		}
	...
	public Map<String, Object> findChapterSearch(Map<String, Object> map, EasyUiPager easyUiPager) {
		try {
			...
			List<Chapter> list = super.findHqlByPager(/* select + */Hql + orderby, (easyUiPager.getPage() - 1) * easyUiPager.getRows(), easyUiPager.getRows());
